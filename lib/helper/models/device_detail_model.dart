...
class DeviceDetail {
  ...
  String? message;
  String? deviceId;
  String? kidDeviceAccountConnectID;
  dynamic resp;
  Data? data;
  int? totalElements;
  ...
  DeviceDetail({
    ...
    this.message,
    this.deviceId,
    this.kidDeviceAccountConnectID,
    this.resp,
    this.data,
    this.totalElements,
  ...
  DeviceDetail copyWith({
    ...
    dynamic excludeColumns,
      ...
      DeviceDetail(
        ...
        kidDeviceAccountConnectID:
            kidDeviceAccountConnectID ?? this.kidDeviceAccountConnectID,
        resp: resp ?? this.resp,
        data: data ?? this.data,
  ...
  factory DeviceDetail.fromJson(Map<String, dynamic> json) => DeviceDetail(
    ...
    kidDeviceAccountConnectID: json["kidDeviceAccountConnectID"],
...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
    ...
    deviceInitTime: (json["deviceInitTime"] as num?)?.toInt(),
    hasAdminReg: (json["hasAdminReg"] as num?)?.toInt(),
    hasMultiUser: (json["hasMultiUser"] as num?)?.toInt(),
    imeiNumber: json["imeiNumber"],
    deviceId: json["deviceId"],
    lastReportedTime: (json["lastReportedTime"] as num?)?.toInt(),
    ...
    deviceLastSuspendTime: (json["deviceLastSuspendTime"] as num?)?.toInt(),
...
class RealTimeStats {
  ...
  factory RealTimeStats.fromJson(Map<String, dynamic> json) => RealTimeStats(
    rtLastUpdatedTime: (json["rtLastUpdatedTime"] as num?)?.toInt(),
    isOnline: (json["isOnline"] as num?)?.toInt(),
    lastUpdatedTime: (json["lastUpdatedTime"] as num?)?.toInt(),
    brightnessLevel: (json["brightnessLevel"] as num?)?.toInt(),
    cpuUtilization: (json["cpuUtilization"] as num?)?.toInt(),
    memoryUsed: (json["memoryUsed"] as num?)?.toInt(),
    powerOnTime: (json["powerOnTime"] as num?)?.toInt(),
    screenOnTime: (json["screenOnTime"] as num?)?.toInt(),
    hasMultiUser: (json["hasMultiUser"] as num?)?.toInt(),
    ...
    numCameras: (json["numCameras"] as num?)?.toInt(),
    cameraActive: json["cameraActive"],
    activeCameraId: json["activeCameraId"],
    deviceTemperature: (json["deviceTemperature"] as num?)?.toDouble(),
    ...
    lastChargerPluggedTime: (json["lastChargerPluggedTime"] as num?)?.toInt(),
    lastLocationUpdateTime: (json["lastLocationUpdateTime"] as num?)?.toInt(),
    ...
    internalStorageUsed: (json["internalStorageUsed"] as num?)?.toInt(),
    internalStorageFree: (json["internalStorageFree"] as num?)?.toInt(),
    internalStorageSize: (json["internalStorageSize"] as num?)?.toInt(),
    sdCardInserted: json["sdCardInserted"],
    sdCardSize: (json["sdCardSize"] as num?)?.toInt(),
    sdCardUsed: (json["sdCardUsed"] as num?)?.toInt(),
    sdCardUsedPercent: (json["sdCardUsedPercent"] as num?)?.toInt(),
    currentSystemTime: (json["currentSystemTime"] as num?)?.toInt(),
    deviceRingerMode: (json["deviceRingerMode"] as num?)?.toInt(),
    screenOrientationMode: (json["screenOrientationMode"] as num?)?.toInt(),
    currentLocale: json["currentLocale"],
    deviceId: (json["deviceId"] as num?)?.toInt(),
    pedometer: (json["pedometer"] as num?)?.toInt(),
    sleepTime: (json["sleepTime"] as num?)?.toInt(),
    appMemoryUsed: (json["appMemoryUsed"] as num?)?.toInt(),
    appMemoryAvailable: (json["appMemoryAvailable"] as num?)?.toInt(),
    subscriptionExpiryDate: (json["subscriptionExpiryDate"] as num?)?.toInt(),
    lastSubscriptionExpiredDate: (json["lastSubscriptionExpiredDate"] as num?)?.toInt(),
    rxBytes: (json["rxBytes"] as num?)?.toInt(),
    txBytes: (json["txBytes"] as num?)?.toInt(),
    rxBytesMobile: (json["rxBytesMobile"] as num?)?.toInt(),
    txBytesMobile: (json["txBytesMobile"] as num?)?.toInt(),
    totalUsedBytes: (json["totalUsedBytes"] as num?)?.toInt(),
    internalStorageUsedPercent: (json["internalStorageUsedPercent"] as num?)?.toInt(),
    ...
    deviceDataUsage: (json["deviceDataUsage"] as num?)?.toInt(),
    deviceWiFiUsage: (json["deviceWiFiUsage"] as num?)?.toInt(),
...
class AppUsageDatum {
  ...
  factory AppUsageDatum.fromJson(Map<String, dynamic> json) => AppUsageDatum(
    ...
    mBgUsageTime: (json["mBgUsageTime"] as num?)?.toInt(),
    mFgUsageTime: (json["mFgUsageTime"] as num?)?.toInt(),
    lastUsedTime: (json["lastUsedTime"] as num?)?.toInt(),
    wifiUsageBytes: (json["wifiUsageBytes"] as num?)?.toInt(),
    dataUsageBytes: (json["dataUsageBytes"] as num?)?.toInt(),
  );
