...
class _MainMenuProfileState extends State<MainMenuProfile> {
  ...
  Widget build(BuildContext context) {
    ...
    return CommonGradientBackground(
      ...
      child: Column(
        children: [
          commonAppBar(heading: "Main Menu"),
          Expanded(
              ...
              child: SingleChildScrollView(
                child: Column(
                  children: [
                    ...
                    customProfileViewer(),
                    verticalSpace(10),
                    bigSubHeading("Leslie Alexander"),
                    ...
                    verticalSpace(20),
                    CustomButton(text: "Logout", color: AppColors.lightRed.withOpacity(0.2), textColor: AppColors.red,icon: AppImages.logout,notExpanded: true,margin: EdgeInsets.zero),
                    verticalSpace(10),
                  ],
                ),
              ),
